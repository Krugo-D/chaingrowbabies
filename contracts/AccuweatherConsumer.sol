...
contract AccuweatherConsumer is ChainlinkClient {
    ...
    // This function can now be used manually to change the game parameters, but eventually should only be called by a bot and filled by an oracle every hour
    function setMockCityData(uint256 locationKey, uint24 _precipitationPastHour, int16 _temperature, uint16 _windSpeed) public {
